...
Methods, tools, and techniques for curating, filtering, and quality-controlling datasets used in LLM fine-tuning.
...
| [style-balancing](./style-balancing/) | Dataset-mix optimization: DoReMi, RegMix, scaling laws, Model Collapse |
